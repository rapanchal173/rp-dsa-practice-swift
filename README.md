...
> 📌 In this document, we'll focus on **Searching** and **Sorting** — the foundation every other algorithm builds on. Future parts can cover Trees, Graphs, and Dynamic Programming.
...
*Document created for learning Data Structures & Algorithms using Swift.*
